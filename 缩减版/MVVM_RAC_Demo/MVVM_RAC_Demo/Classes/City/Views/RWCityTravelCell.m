...
@implementation RWCityTravelCell
...
{
    RWCityTravelViewModel *cityViewModel = viewModel;
    RWCityTravelItemModel *model = cityViewModel.travelData[[params[DataIndex] integerValue]];
...
//时间--浏览数
- (NSString *)subTimeStringWithViewModel:(RWCityTravelItemModel *)model
{
